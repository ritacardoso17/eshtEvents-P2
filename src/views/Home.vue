  ...
  <div class="home">
    <div class="container">
      ...
      <div class="row" id="text">
        <p>
          <br />
          <br />O Restaurante de Aplicação da Escola Superior de Hotelaria e Turismo é da responsabilidade do Politécnico do Porto,
          <br />com capacidade para 50 pessoas sentadas.
    ...
    <!-- PRIMEIRO CARD -->
    <div class="container">
      <b-card no-body class="overflow-hidden" id="firstCard">
    ...
    <div class="container">
      <b-card no-body class="overflow-hidden" id="firstCard">
        ...
        <b-row no-gutters>
          <b-col md="6">
            <b-img src="../assets/cozinha.jpg" class="rounded-0" id="imgCard2"></b-img>
          </b-col>
          <b-col md="6">
            <b-card-body title>
    ...
    <div class="container">
      <b-card no-body class="overflow-hidden" id="firstCard">
        ...
        <b-row no-gutters>
          <b-col md="6">
            <b-img src="../assets/works.jpg" class="rounded-0" id="imgCard1"></b-img>
          </b-col>
          <b-col md="6">
            <b-card-body title>
              <b-card-text class="text">
